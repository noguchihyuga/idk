...
local r = {
    Darker = {
        Colors = {
			...
			Primary = Color3.fromRGB(64, 156, 255),  -- 🔵 Xanh nước biển sáng cho toggle/slider chính
            OnPrimary = Color3.fromRGB(0, 90, 180),   -- 🔵 Xanh nước biển đậm hơn
            ...
            JoinButton = Color3.fromRGB(0, 120, 215),  -- 🔵 Xanh nước biển cho nút "Go to Server"
            Link = Color3.fromRGB(64, 156, 255),       -- 🔵 Xanh nước biển sáng cho link

            Dialog = {
                Background = Color3.fromRGB(30, 30, 30)
            },
            Buttons = {
                Holding = Color3.fromRGB(40, 40, 40),
                Default = Color3.fromRGB(35, 35, 35)
            },
            Border = {
                Holding = Color3.fromRGB(80, 140, 255),  -- 🔵 Xanh nước biển nhạt khi hover
            ...
            Slider = {
                SliderBar = Color3.fromRGB(64, 156, 255),  -- 🔵 Thanh slider xanh nước biển
                SliderNumber = Color3.fromRGB(180, 220, 255),  -- 🔵 Số slider xanh nhạt
            },
            Dropdown = {

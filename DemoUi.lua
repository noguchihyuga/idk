...
Configs = Configs or {}
	local WTitle = Configs[1] or Configs.Name or Configs.Title or "Teddy Hub"
	local WMiniText = Configs[2] or Configs.SubTitle or "by @_teddyhub"
	...
	function Window:T(Configs)
		...
		function Tab:AddSeperator(Configs)
			local SectionName = type(Configs) == "string" and Configs or Configs[1] or Configs.Name or Configs.Title or Configs.Section
		...
		function Tab:AddButton(Configs)
			...
			local Callback = Configs.Callback or Funcs:GetCallback(Configs, 2)
		...
		function Tab:AddToggle(Configs)
			...
			local Callback = Configs.Callback or Funcs:GetCallback(Configs, 3)
		...
		function Tab:AddDropdown(Configs)
			...
			local DOptions = Configs[2] or Configs.Values or {}
			local OpDefault = Configs[3] or Configs.Default or {}
			local Flag = Configs[5] or Configs.Flag or false
			local DMultiSelect = Configs.Multi or false
			local Callback = Configs.Callback or Funcs:GetCallback(Configs, 4)
		...
		function Tab:AddSlider(Configs)
			...
			local Increase = Configs[4] or Configs.Rounding or 1
		...
		function Tab:AddInput(Configs)
			...
			local TPlaceholderText = Configs[5] or Configs.Placeholder or "Input"

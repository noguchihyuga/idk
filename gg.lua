...
function library:Window(tnhuw, keycode)
    tnhuw = tnhuw or {
        ["Title"] = "Pro Hub",
        ["SubTitle"] = "Blox Fruits"
    }
    title = tnhuw.Title
    description = tnhuw.SubTitle
    ...
    function library2:Tab(name)
        ...
        function library3:Toggle(text, default,subtitle, callback)
            local library4 = {}
            ...
            if default == true then
                library4:Toggle(default or false)
            end
        ...
        function library3:Textbox(text, default, callback)
            local library4 = {}
            library4["Text"] = ""
        ...
        function library3:Slider(text, min, max,def, callback)
            local library4 = {}
            library4["Value"] = nil
            callback = callback or function() end
            ...
            library4:SetValue(def or max / 2)
        ...
        function library3:Dropdown(text, list,def, callback)
            local library4 = {}
            library4["Options"] = {}
            ...
            if def then
                spawn(function() callback(def) end)
            end
    ...
    function library2:Notification(title, description, callback)
        callback = callback or function() end
